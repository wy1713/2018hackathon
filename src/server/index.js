...
function getHtml (list) {
  var content = '<div style="text-align: center"> <a href="http://localhost:3000/">CSR (Client Side Rendering)</a> <h1>SSR (Server Side Rendering)</h1><h2>- React, Next, Express, Node.js, FAAS</h2><h1>List (20,000 Items from Serverless Cloud FAAS)</h1><ul>';
